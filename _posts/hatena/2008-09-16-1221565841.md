...
categories:
- WPF
source_url: http://tkatochin.hatenablog.com/entry/20080916/1221565841
edit_url: https://blog.hatena.ne.jp/t-katochin/tkatochin.hatenablog.com/atom/entry/6653586347154754532
permalink: "/entry/20080916/1221565841/"
---
{% include JB/setup %}
...
　では…と、[こちらの、まめしば雑記](<http://d.hatena.ne.jp/shiba-yan/20080809/1218212316>)にもあるように、以下のようにインクルード的にMargedDictionariesを使うという方法をやってみた。
```xml
<ResourceDictionary xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
                    xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml">
    <ResourceDictionary.MergedDictionaries>
