...
categories:
- svn
source_url: http://tkatochin.hatenablog.com/entry/20070911/1189476634
edit_url: https://blog.hatena.ne.jp/t-katochin/tkatochin.hatenablog.com/atom/entry/6653586347154755212
permalink: "/entry/20070911/1189476634/"
---
{% include JB/setup %}

　「別のリポジトリのデータを取り込む方法が調べたけど無かったので、最新だけコミットすることにしました。」とあるお客さんのシステム部から連絡があった。まさか！方法はあるでしょー。ただその時は「調べた」ゆーてるしツッコミは避けて聞き流すことにした。
　で、電話の後やっぱり[方法はあった](<http://subversion.bluegate.org/doc/ch05s03.html>)。今後のこともあるので実験。
```
