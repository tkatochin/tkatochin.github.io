...
categories:
- tomcat
source_url: http://tkatochin.hatenablog.com/entry/20071002/1191303177
edit_url: https://blog.hatena.ne.jp/t-katochin/tkatochin.hatenablog.com/atom/entry/6653586347154755156
permalink: "/entry/20071002/1191303177/"
---
{% include JB/setup %}

　maven2のwarプロジェクトとtomcat pluginの組み合わせでちゃんと動作するようになるまでの手順を以下にまとめておく。
+[tomcat plugin 3.2.1(私のパッチを当てたもの)](<http://package.gluegent.com/~kato/download/com.sysdeo.eclipse.tomcat_3.2.1_pached_m2referproject.zip>)に入れ替える。
+warプロジェクトのsrc/main/webapp/WEB-INF/libの中身は空にする。
--※※ちなみにmayaaとの組み合わせでは注意が必要。mayaaでは、タグライブラリの定義(tld)を得るために WEB-INF/libの中にあるものをあてにするため。[参考](<http://ml.seasar.org/archives/mayaa-user/2006-August/000271.html>)
...
--※※ちなみにS2Strutsを使う場合は、jarからactionやdtoを扱えるようにするために、enableJarやjarFilePatternの指定が必要。[参考](<http://s2struts.seasar.org/ja/s2struts.html#ZeroConfigReference>)
