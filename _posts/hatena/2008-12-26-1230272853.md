...
categories:
- eclipse
source_url: http://tkatochin.hatenablog.com/entry/20081226/1230272853
edit_url: https://blog.hatena.ne.jp/t-katochin/tkatochin.hatenablog.com/atom/entry/6653586347154754337
permalink: "/entry/20081226/1230272853/"
---
{% include JB/setup %}

　[こちら](<http://www.eclipse.org/swt/jnigen.php>)の8.を見ると、ant buildすればswtがサクっとビルドできるように錯覚するけど、めちゃくちゃビルド環境が整っていること前提になっている。何も考えずにant掛けると「ドライブが無効」だとかがコンソールに２回ほど出る。それもそのはずで、[Eclipse SWT PI/win32]/libary/build.xmlは結局その中のbuild.batを叩くんだけど、batの中身が以下のような有り様。
```dosbatch
