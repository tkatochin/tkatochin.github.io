...
categories:
- eclipse
source_url: http://tkatochin.hatenablog.com/entry/20090105/1231141355
edit_url: https://blog.hatena.ne.jp/t-katochin/tkatochin.hatenablog.com/atom/entry/6653586347154754331
permalink: "/entry/20090105/1231141355/"
---
{% include JB/setup %}
...
<<
なるほど。最新を取ってしまっていたのが駄目だったみたい。[この辺](<http://mirrors.linux.edu.lv/mozilla.org/xulrunner/releases/1.8.0.4/sdk/>)から1.8.0.4をダウンロードしてパスをセット。
　で、ようやくビルド成功した。
```
    :
...
　さて次は、swtのplugin-jarを作る方法を調べないと。[http://www.eclipse.org/swt/faq.php#howbuildplugin](<http://www.eclipse.org/swt/faq.php#howbuildplugin>)に従ってみたけどswtの.classもネィティブdllも含まれない空っぽのjarができるだけ。ええっ！？copyやらjavacやらantタスク自分で書くの？絶対自動化しているやつ何処かにあると思うけどなー。
